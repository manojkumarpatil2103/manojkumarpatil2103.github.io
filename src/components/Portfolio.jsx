  ...
  const projects = [
    {
      ...
      description:
        "Full-stack blog application with user authentication, CRUD operations, and post uploads. Built with React.js frontend and Appwrite backend-as-a-service.",
    ...
    },
    {
      ...
      description:
        "Complete video hosting platform with advanced features including authentication, video uploads, social interactions, and subscription system using JWT and bcrypt.",
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-400 max-w-3xl mx-auto mb-12 leading-relaxed">
              Innovative Computer Science graduate specializing in decentralized
              applications and modern web development. Passionate about creating
              secure, scalable solutions that bridge blockchain technology with
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <a
              href="mailto:manojkumarpatil2103@gmail.com"
              className="flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 px-6 py-3 rounded-full transition-all duration-300 transform hover:scale-105"
            >
              <Mail size={20} />
              Get In Touch
            </a>
          ...
          <div className="flex justify-center space-x-6">
            <a
              href="https://github.com/manojkumarpatil2103"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/manoj-kumar-patil-b96875202/"
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-all duration-300 transform hover:scale-110"
            >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-gray-300 leading-relaxed">
                Recent Computer Science graduate with a passion for blockchain
                technology and full-stack development. I specialize in building
                decentralized applications on Ethereum using Solidity and
                creating modern web applications with the MERN stack.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                My journey in technology is driven by curiosity and innovation.
                I enjoy solving complex problems and delivering secure, scalable
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {Object.entries(skills).map(([category, skillList], index) => (
              <div
                key={category}
                className="bg-white/5 p-6 rounded-lg border border-white/10 hover:border-cyan-400/50 transition-all duration-300 transform hover:scale-105"
              >
                <div className="flex items-center mb-4">
                  {category.includes("Programming") && (
                    <Code className="text-cyan-400 mr-3" size={24} />
                  )}
                  {category.includes("Blockchain") && (
                  ...
                  {category.includes("Frontend") && (
                    <Smartphone className="text-pink-400 mr-3" size={24} />
                  )}
                ...
                <div className="flex flex-wrap gap-2">
                  {skillList.map((skill) => (
                    <span
                      key={skill}
                      className="px-3 py-1 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rounded-full text-sm border border-white/10"
                    >
                      {skill}
                    </span>
                  ))}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="bg-white/5 p-6 rounded-lg border border-white/10 hover:border-cyan-400/50 transition-all duration-300 transform hover:scale-105 group"
              >
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed mb-8">
                    ...
                    innovative projects, and collaborations in blockchain and
              ...
              <div className="bg-white/5 p-8 rounded-lg border border-white/10">
                <div className="space-y-6">
                  ...
                  <button
                    onClick={() =>
                      window.open(
                        "mailto:manojkumarpatil2103@gmail.com",
                        "_blank"
                      )
                    }
